...
namespace org.transliteral.panchang
{
    public class AshtottariDasa : NakshatraDasa, INakshatraDasa
	{
		...
		public BodyName LordOfNakshatra(Nakshatra n) 
		{
			switch (n.Value)
			{
				case NakshatraName.Ashwini : return BodyName.Rahu ;
				...
				case NakshatraName.Mrigashira : return BodyName.Venus ;
				case NakshatraName.Ardra : return BodyName.Sun ;
				case NakshatraName.Punarvasu : return BodyName.Sun ;
				case NakshatraName.Pushya : return BodyName.Sun ;
				case NakshatraName.Ashlesha : return BodyName.Sun ;
				case NakshatraName.Magha : return BodyName.Moon ;
				...
				case NakshatraName.Chitra : return BodyName.Mars ;
				case NakshatraName.Swati : return BodyName.Mars ;
				case NakshatraName.Vishakha : return BodyName.Mars ;
				...
				case NakshatraName.Shravana : return BodyName.Saturn ;
				case NakshatraName.Dhanishta : return BodyName.Jupiter ;
				case NakshatraName.Shatabhisha : return BodyName.Jupiter ;
