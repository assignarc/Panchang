...
namespace org.transliteral.panchang
{
    ...
    public class Sweph1
    {
        ...
        private static SwissEphNet.SwissEph swissEph;

        public static void Initialize()
        {
            if (swissEph == null)
            {
                swissEph = new SwissEphNet.SwissEph();
                swissEph.OnLoadFile += SwissEph_OnLoadFile;
            }
        }

        private static void SwissEph_OnLoadFile(object sender, SwissEphNet.LoadFileEventArgs e)
        {
        ...
        public static void swe_set_sid_mode(int sid_mode, double t0, double ayan_t0)
        {
            ...
            swissEph.swe_set_sid_mode(sid_mode, 0.0, 0.0);
        }
        ...
        {
            double d = 0.0;
            swissEph.swe_revjul(tjd,1,ref year,ref month,ref day,ref d);
