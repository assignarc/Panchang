...
namespace org.transliteral.panchang
{
    public class GhatakaStar
	{
        public static bool CheckStar(ZodiacHouse janmaRasi, Nakshatra nak)
		{
			...
			NakshatraName gh = NakshatraName.Ashwini;
			switch (ja)
			{
				case ZodiacHouseName.Ari: gh = NakshatraName.Magha; break;
				...
				case ZodiacHouseName.Vir: gh = NakshatraName.Shravana; break;
				case ZodiacHouseName.Lib: gh = NakshatraName.Shatabhisha; break;
				...
				case ZodiacHouseName.Aqu: gh = NakshatraName.Ardra; break;
				case ZodiacHouseName.Pis: gh = NakshatraName.Ashlesha; break;
			}
			return nak.Value == gh;
		}
	}
