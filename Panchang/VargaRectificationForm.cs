...
//							x_offset, varga_y - sz.Height);
		...
		private void menuShadvargas_Click(object sender, System.EventArgs e)
		{
            ...
            this.opts.Divisions = (Division[]) Basics.Shadvargas();
			this.PopulateCache();
			this.bmpBuffer = null;
			this.Invalidate();
		}
		...
		{
			//TODO: Recheck the typecasting
			this.opts.Divisions =(Division[]) Basics.Saptavargas();
			this.PopulateCache();
			this.bmpBuffer = null;
			this.Invalidate();
		}
		...
		{
            //TODO: Recheck the typecasting
            this.opts.Divisions = (Division[]) Basics.Dasavargas();
			this.PopulateCache();
			this.bmpBuffer = null;
			this.Invalidate();
		}
		...
		{
            //TODO: Recheck the typecasting
            this.opts.Divisions = (Division[]) Basics.Shodasavargas();
			this.PopulateCache();
			this.bmpBuffer = null;
			this.Invalidate();
		}
