...
{
    /// <summary>
    /// Summary description for AboutHora.
    /// </summary>
    public class AboutHora : System.Windows.Forms.Form
	{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(AboutHora));
			...
			this.label6.Text = "Panchanga Hora";
			// 
			// label7
			// 
			...
			this.Text = "About Panchanga Hora";
		...
		private void linkMail_LinkClicked(object sender, System.Windows.Forms.LinkLabelLinkClickedEventArgs e)
		{
			try
			{
				System.Diagnostics.Process.Start("mailto:" + this.linkMail.Text + "?subject=PanchangaHora");
			}
			catch {}
		}
