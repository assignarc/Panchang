...
namespace mhora
{
	...
	/// </summary>
	public class HoraOptions : System.Windows.Forms.Form
	{
		...
		public HoraOptions(Object a, ApplyOptions o, bool NoCancel)
		{
			InitializeComponent();
		...
		public HoraOptions(Object a, ApplyOptions o)
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            this.pGrid.Location = new System.Drawing.Point(16, 15);
            this.pGrid.Name = "pGrid";
            this.pGrid.PropertySort = System.Windows.Forms.PropertySort.Categorized;
            this.pGrid.Size = new System.Drawing.Size(272, 168);
            ...
            this.bApply.Location = new System.Drawing.Point(16, 197);
            this.bApply.Name = "bApply";
            this.bApply.Size = new System.Drawing.Size(150, 43);
            ...
            this.bCancel.Location = new System.Drawing.Point(112, 197);
            this.bCancel.Name = "bCancel";
            this.bCancel.Size = new System.Drawing.Size(150, 43);
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
            this.bOK.Location = new System.Drawing.Point(208, 197);
            this.bOK.Name = "bOK";
            this.bOK.Size = new System.Drawing.Size(0, 43);
            this.bOK.TabIndex = 3;
            this.bOK.Text = "OK";
	...
	public class GlobalizedPropertiesWrapper : ICustomTypeDescriptor
	{
		...
		public bool IsPropertyVisible (PropertyDescriptor prop)
		{
            ...
            Logger.Info(String.Format("Property {0} is invisible", prop.DisplayName));
			return true;
		}
		public PropertyDescriptorCollection GetProperties(Attribute[] attributes)
		{
			...
			foreach (PropertyDescriptor oProp in baseProps)
			{
                ...
                Logger.Info(String.Format("Enumerating property {0}", oProp.DisplayName));
                //PGDisplayName invisible = (PGDisplayName)oProp.Attributes[typeof(PGNotVisible)];
                //if (invisible == null)
                //else
                //	Logger.Info(String.Format ("Property {0} is invisible", oProp.DisplayName));
            }

            orderedProperties.Sort();
			foreach (PropertyOrderPair pop in orderedProperties)
			{
				Logger.Info(String.Format("Adding sorted {0}", pop.Name));
