...
namespace org.transliteral.panchang.app
{
    ...
    public class PanchangPrintDocument : PrintDocument
    {
        protected Horoscope h;
        public PanchangPrintDocument(Horoscope _h)
        {
            h = _h;
        }
        ...
        protected override void OnBeginPrint(PrintEventArgs e)
        {
            ...
            for (int i = (int)DivisionType.HoraParasara;
                i <= (int)DivisionType.DwadasamsaDwadasamsa; i++)
        ...
        private void PrintHeader(PrintPageEventArgs e)
        {
            ...
            SizeF sz = e.Graphics.MeasureString(s, f_sanskrit);
            e.Graphics.TranslateTransform(e.MarginBounds.Left, e.MarginBounds.Top);
            e.Graphics.DrawString(s, f_sanskrit, Brushes.Black,
        ...
        private void PrintDrigDasa(PrintPageEventArgs e)
        {
            ...
            vd.options.SeedBody = StartBodyType.Lagna;
        ...
        private void PrintVargas(PrintPageEventArgs e)
        {
            ...
            if (false == GetNextVarga(ref dtype)) return;
        ...
        private void PrintCoverPage(PrintPageEventArgs e)
        {
            ...
            // Vimsottari Dasa
            VimsottariDasa vd = new VimsottariDasa(h);
            vd.options.SeedBody = StartBodyType.Moon;
            PrintVimDasa(vd);
