...
namespace mhora
{
	...
	public class DivisionalChart : MhoraControl //System.Windows.Forms.UserControl
	{
		...
		*/
		...
		{
			this.options.Varga = new Division(DivisionType.Rasi);
			this.OnRecalculate(h);
			this.Invalidate();
		}
		...
		{
			this.options.Varga = new Division(DivisionType.Navamsa);
			this.OnRecalculate(h);
			this.Invalidate();
		}
		...
		{
			this.options.Varga = new Division(DivisionType.Chaturthamsa);
			this.OnRecalculate(h);
			this.Invalidate();
		}
		...
		{
			this.options.Varga = new Division(DivisionType.Panchamsa);
			this.OnRecalculate(h);
			this.Invalidate();		
		}
		...
		{
			this.options.Varga = new Division(DivisionType.Shashthamsa);
			this.OnRecalculate(h);
			this.Invalidate();		
		}
		...
		{
			this.options.Varga = new Division(DivisionType.Saptamsa);
			this.OnRecalculate(h);
			this.Invalidate();				
		}
		private void mAshtamsa_Click(object sender, System.EventArgs e)
		{
			this.options.Varga  = new Division(DivisionType.Ashtamsa);
			this.OnRecalculate(h);
			this.Invalidate();
		}
		private void mAshtamsaRaman_Click(object sender, System.EventArgs e)
		{
			this.options.Varga = new Division(DivisionType.AshtamsaRaman);
			this.OnRecalculate(h);
			this.Invalidate();
		}
		...
		{
			this.options.Varga = new Division(DivisionType.Dasamsa);
			this.OnRecalculate(h);
			this.Invalidate();				
		}
		...
		{
			this.options.Varga = new Division(DivisionType.Dwadasamsa);
			this.OnRecalculate(h);
			this.Invalidate();				
		}
		...
		{
			this.options.Varga = new Division(DivisionType.Shodasamsa);
			this.OnRecalculate(h);
			this.Invalidate();				
		}
		...
		{
			this.options.Varga = new Division(DivisionType.Vimsamsa);
			this.OnRecalculate(h);
			this.Invalidate();				
		}
		...
		{
			this.options.Varga = new Division(DivisionType.Chaturvimsamsa);
			this.OnRecalculate(h);
			this.Invalidate();				
		}
		...
		{
			this.options.Varga = new Division(DivisionType.Nakshatramsa);
			this.OnRecalculate(h);
			this.Invalidate();				
		}
		...
		{
			this.options.Varga = new Division(DivisionType.Trimsamsa);
			this.OnRecalculate(h);
			this.Invalidate();				
		}
		...
		{
			this.options.Varga = new Division(DivisionType.Khavedamsa);
			this.OnRecalculate(h);
			this.Invalidate();				
		}
		...
		{
			this.options.Varga = new Division(DivisionType.DrekkanaJagannath);
			this.OnRecalculate(h);
			this.Invalidate();				
		}
		...
		{
			this.options.Varga = new Division(DivisionType.DrekkanaSomnath);
			this.OnRecalculate(h);
			this.Invalidate();				
		}
		...
		{
			this.options.Varga = new Division(DivisionType.DrekkanaParivrittitraya);
			this.OnRecalculate(h);
			this.Invalidate();				
		}
		...
		{
			this.options.Varga = new Division(DivisionType.HoraKashinath);
			this.OnRecalculate(h);
			this.Invalidate();
		}
		...
		{
			this.options.Varga = new Division(DivisionType.HoraParivrittiDwaya);
			this.OnRecalculate(h);
			this.Invalidate();
		}
		...
		{
			this.options.Varga = new Division(DivisionType.HoraParasara);
			this.OnRecalculate(h);
			this.Invalidate();
		}
		...
		{
			this.options.Varga = new Division(DivisionType.HoraJagannath);
			this.OnRecalculate(h);
			this.Invalidate();
		}
		...
		{
			this.options.Varga = new Division(DivisionType.TrimsamsaParivritti);
			this.OnRecalculate(h);
			this.Invalidate();
		}
		private void mTrimsamsaSimple_Click(object sender, System.EventArgs e)
		{
			this.options.Varga = new Division(DivisionType.TrimsamsaSimple);
			this.OnRecalculate(h);
			this.Invalidate();
		}
		...
		{
			VargaRectificationForm vf = new VargaRectificationForm(h, this, (Division) this.options.Varga);
			vf.Show();
		}
		...
		{
			this.options.Varga = new Division(DivisionType.Akshavedamsa);
			this.OnRecalculate(h);
			this.Invalidate();				
		}
		...
		{
			this.options.Varga = new Division(DivisionType.Shashtyamsa);
			this.OnRecalculate(h);
			this.Invalidate();				
		}
		...
		{
			this.options.Varga = new Division(DivisionType.Rudramsa);
			this.OnRecalculate(h);
			this.Invalidate();
		}
		private void mRudramsaRaman_Click(object sender, System.EventArgs e)
		{
			this.options.Varga = new Division(DivisionType.RudramsaRaman);
			this.OnRecalculate(h);
			this.Invalidate();
		}
		private void mNadiamsa_Click(object sender, System.EventArgs e)
		{
			this.options.Varga = new Division(DivisionType.Nadiamsa);
			this.OnRecalculate(h);
			this.Invalidate();
		}
		private void mNadiamsaCKN_Click(object sender, System.EventArgs e)
		{
			this.options.Varga = new Division(DivisionType.NadiamsaCKN);
			this.OnRecalculate(h);
			this.Invalidate();
		}
		private void mNavamsaDwadasamsa_Click(object sender, System.EventArgs e)
		{
			this.options.Varga = new Division(DivisionType.NavamsaDwadasamsa);
			this.OnRecalculate(h);
			this.Invalidate();
		}
		...
		{
			this.options.Varga = new Division(DivisionType.DwadasamsaDwadasamsa);
			this.OnRecalculate(h);
			this.Invalidate();
		}
		private void menuItem7_Click(object sender, System.EventArgs e)
		{
			this.options.Varga = new Division(DivisionType.Ashtottaramsa);
			this.OnRecalculate(h);
			this.Invalidate();
		...
		{
			Division.CopyToClipboard((Division)this.options.Varga);
		}
